...
- (void)initVuforiaInBackground
{
    ...
    @autoreleasepool {
        Vuforia::setInitParameters(mVuforiaInitFlags,"");
...
- (bool)startCamera:(Vuforia::CameraDevice::CAMERA_DIRECTION)camera viewWidth:(float)viewWidth andHeight:(float)viewHeight error:(NSError **)error
{
    ...
    _projectionMatrix = Vuforia::Tool::getProjectionGL(cameraCalibration, PROJECTION_NEAR_PLANE, PROJECTION_FAR_PLANE);
